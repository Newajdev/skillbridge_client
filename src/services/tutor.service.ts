...
export const tutorService = {
    getTutors: async function (
        ...
        try {
            ...
            if (!res.ok) {
                return { data: null, error: { message: data.message || "Failed to fetch tutors" } };
            }
    ...
    getTutorById: async function (id: string, options?: ServiceOptions) {
        try {
            ...
            if (!res.ok) {
                return { data: null, error: { message: data.message || "Failed to fetch tutor details" } };
            }
    ...
    getCategories: async function (options?: ServiceOptions) {
        try {
            ...
            if (!res.ok) {
                return { data: null, error: { message: data.message || "Failed to fetch categories" } };
            }
